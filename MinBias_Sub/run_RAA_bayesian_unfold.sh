...
root -b -q RAA_dataDrivenUnfoldingErrorCheck.C\+\(2,1,1\)
root -b -q RAA_analyze.C\+\(2,1,1\)

echo "Running for R=0.3"
root -b -q RAA_dataDrivenUnfoldingErrorCheck.C\+\(3,1,1\)
root -b -q RAA_analyze.C\+\(3,1,1\)

echo "Running for R=0.4"
root -b -q RAA_dataDrivenUnfoldingErrorCheck.C\+\(4,1,1\)
