...
do
    ...
    Error="akPu$radius-PbPbMBData-$endfile.err"
    Output="akPu$radius-PbPbMBData-$endfile.out"
    Log="akPu$radius-PbPbMBData-$endfile.log"
...
transfer_input_files = $tardir/jetRAA_run_PbPb_MB_Data.tar
