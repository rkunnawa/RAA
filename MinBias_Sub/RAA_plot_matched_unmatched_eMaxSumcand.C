...
void RAA_plot_matched_unmatched_eMaxSumcand(Int_t radius = 2){
  ...
  for(int a = 0;a<ptSelection; ++a) {
    ...
    Data_matched->Draw(Form("eMax/(chSum+phSum+neSum+muSum):calopt/pfpt>>hData_eMaxSumcand_calopfpt_ptselection_%d",a),Form("pfpt > %d && pfpt < %d && jet80", ptBoundary[a], ptBoundary[a+1]),"goff");
    MC_matched->Draw(Form("eMax/(chSum+phSum+neSum+muSum):calopt/pfpt>>hMC_eMaxSumcand_calopfpt_ptselection_%d",a),Form("pfpt > %d && pfpt < %d && jet80", ptBoundary[a], ptBoundary[a+1]),"goff");
    MC_matched->Draw(Form("eMax/(chSum+phSum+neSum+muSum):calopt/pfpt>>hMC_eMaxSumcand_calopfpt_refptselection_%d",a),Form("pfpt > %d && pfpt < %d && refpt > %d && refpt < %d && jet80",  ptBoundary[a], ptBoundary[a+1],  ptBoundary[a], ptBoundary[a+1]),"goff");

    Data_unmatched->Draw(Form("eMax/(chSum+phSum+neSum+muSum):(pfpt-pfpt)>>hData_unmatch_eMaxSumcand_calopfpt_ptselection_%d",a),Form("pfpt > %d && pfpt < %d && jet80", ptBoundary[a], ptBoundary[a+1]),"goff");
    MC_unmatched->Draw(Form("eMax/(chSum+phSum+neSum+muSum):(pfpt-pfpt)>>hMC_unmatch_eMaxSumcand_calopfpt_ptselection_%d",a),Form("pfpt > %d && pfpt < %d && jet80", ptBoundary[a], ptBoundary[a+1]),"goff");
    MC_unmatched->Draw(Form("eMax/(chSum+phSum+neSum+muSum):(pfpt-pfpt)>>hMC_unmatch_eMaxSumcand_calopfpt_refptselection_%d",a),Form("pfpt > %d && pfpt < %d && refpt > %d && refpt < %d && jet80",  ptBoundary[a], ptBoundary[a+1],  ptBoundary[a], ptBoundary[a+1]),"goff");
    ...
    ceMaxSumcand[a]->SaveAs(Form("May20/eMaxOverSumCand_calpfpt_PbPbJet80_showingCut_fullstat_R0p%d_%d_ptrange_%d.pdf",radius, ptBoundary[a], ptBoundary[a+1]),"RECREATE");
