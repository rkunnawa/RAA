...
void RAA_fragBiasCheck_pp_data(int startfile = 0,int endfile = 1,char *jet_type = "PF"){
  ...
  for(int k = 0;k<no_radius;k++){
    ...
    jetPP[2][k]->SetBranchAddress("nPFpart",&nPFpart);
    jetPP[2][k]->SetBranchAddress("pfId",&pfID);
    jetPP[2][k]->SetBranchAddress("pfPt",&pfPt);
    jetPP[2][k]->SetBranchAddress("pfVsPt",&pfVsPt);
    jetPP[2][k]->SetBranchAddress("pfVsPtInitial",&pfVsPtInitial);
    jetPP[2][k]->SetBranchAddress("pfArea",&pfArea);
    jetPP[2][k]->SetBranchAddress("pfEta",&pfEta);
    jetPP[2][k]->SetBranchAddress("pfPhi",&pfPhi);
  ...
  for(int k = 0;k<no_radius;k++){
	...
	for(int g = 0;g<nrefe_1;g++){
	  ...
	  if(jet80_1==1  && trgObj_pt_1>=80) {

	    hJets_noTrkpTCut[k][j][2]->Fill(pt_1[g]);
	    if(large > 3) hJets_3TrkpTCut[k][j][2]->Fill(pt_1[g],jet80_p_1);
	    if(large > 5) hJets_5TrkpTCut[k][j][2]->Fill(pt_1[g],jet80_p_1);
	    if(large > 7) hJets_7TrkpTCut[k][j][2]->Fill(pt_1[g],jet80_p_1);
	    if(large > 10) hJets_10TrkpTCut[k][j][2]->Fill(pt_1[g],jet80_p_1);
	      
	  }

	  if(jet60_1==1  && trgObj_pt_1<80  && trgObj_pt_1>=60){

	    hJets_noTrkpTCut[k][j][1]->Fill(pt_1[g]);
	    if(large > 3) hJets_3TrkpTCut[k][j][1]->Fill(pt_1[g],jet60_p_1);
	    if(large > 5) hJets_5TrkpTCut[k][j][1]->Fill(pt_1[g],jet60_p_1);
	    if(large > 7) hJets_7TrkpTCut[k][j][1]->Fill(pt_1[g],jet60_p_1);
	    if(large > 10) hJets_10TrkpTCut[k][j][1]->Fill(pt_1[g],jet60_p_1);

	  }

	  if(jet40_1==1 && trgObj_pt_1<60  && trgObj_pt_1>=40){
	    
	    hJets_noTrkpTCut[k][j][0]->Fill(pt_1[g]);
	    if(large > 3) hJets_3TrkpTCut[k][j][0]->Fill(pt_1[g],jet40_p_1);
	    if(large > 5) hJets_5TrkpTCut[k][j][0]->Fill(pt_1[g],jet40_p_1);
	    if(large > 7) hJets_7TrkpTCut[k][j][0]->Fill(pt_1[g],jet40_p_1);
	    if(large > 10) hJets_10TrkpTCut[k][j][0]->Fill(pt_1[g],jet40_p_1);
  ...
  TFile f(Form("/net/hisrv0001/home/rkunnawa/WORK/RAA/CMSSW_5_3_20/src/Output/pp_data_fragbiascheck_ak%s_%d_%d.root",jet_type,date.GetDate(),endfile),"RECREATE");
  f.cd();
