...
class bayesianUnfold {
   ...
   bayesianUnfold(TH2F *hResponse, TH1F *hPriorDist,double a=0.1)
   {
   ...
   TH1F* reproduce(TH1F* hist); // do unfolding
   int doUnfolding();
...
//    Start Unfolding 
// ==============================================================
int bayesianUnfold::unfold(TH1F* hM, int n)
{
...
TH1F *bayesianUnfold::reproduce(TH1F* hist)
{
    TH1F *hRep = (TH1F*)hReproduced->Clone();
