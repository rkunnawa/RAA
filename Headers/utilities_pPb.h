...
static const char *algoName[nAlgos] = { "", "icPu5", "akPu2PF", "akPu3PF", "akVs4PF", "akPu5PF" , "akPu2Calo", "akPu3Calo", "akPu4Calo" };
...
//Double_t ncoll[nbins_cent] = {10.8,62.8,251,745,1310,1660};
...
{
public:
  JetData(char *fileName, char *jetTree, char *genJetTree, bool loadGenJet = 0,bool isPbPb = 1) {
		...
		cout<<"passed the tree declaration"<<endl;
		...
		else tSkim->SetBranchAddress("pPAcollisionEventSelection",&pPAcollisionEventSelectionPA);
		tJet->AddFriend(tEvt);
